 ...
 *  CSE 154 AC/ Tran
 *
 *  Homework 4. Practice with Node.js. This file handles the Javascript for the public page.
 *  This page is populated with data from FETCHES to app.js bookreads API. The page is a list of
 *  books. If a book is clicked details from the API about it will be pulled up.
 */
...
(function() {
  ...
  /**
   * Handles switching from single to all book mode
   */
  ...
  function spotifyLogin() {
    ...
    logstate = true; // We should check the reposnse to garuntee this
  }
